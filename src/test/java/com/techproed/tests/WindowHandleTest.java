...
public class WindowHandleTest extends TestBase {
    ...
    public void cokluPencereTest(){
        ...
        Set<String> yeniSayfa = driver.getWindowHandles();
//        for (String handle: yeniSayfa) {
//            System.out.println(handle);
//        }

        Object[] array = (Object[]) yeniSayfa.toArray();
        String sonSayfa = array[array.length-1].toString();
